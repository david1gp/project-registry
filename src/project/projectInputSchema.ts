...
const projectCaddyInputSchema = a.object({
...
export const projectInputSchema = a.object({
  schemaVersion: a.optional(a.literal(1), 1),
  ...
  caddy: a.optional(a.nullable(projectCaddyInputSchema)),
})

export type ProjectInput = a.InferOutput<typeof projectInputSchema>
