...
describe("projectRegistryCliArgumentsParse", () => {
  test.each([
    ...
    [["docs", "guide/intro.md"], { kind: "docs-local", path: "guide/intro.md", http: false }],
    [["docs", "guide/intro.md", "--http"], { kind: "docs-local", path: "guide/intro.md", http: true }],
  ...
  test.each([
    ...
    [
      ["project", "edit", "site", "--service", "api", "--ownership", "internal"],
      "Option --ownership must be registry or external.",
    ],
    ...
    [
      ["user", "default-domain", "set", "example.com", "extra"],
      "Unknown command or invalid syntax: user default-domain set example.com extra.",
    ],
    [["user", "default-domain", "set", "not a domain"], "domain is invalid"],
    [
