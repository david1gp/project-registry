...
printf '%s\n' \
  ...
  > "$environment_stage"
if [[ -n "$SERVER_IP" ]]; then
  printf 'SERVER_IP=%s\n' "$SERVER_IP" >> "$environment_stage"
fi
if [[ -n "$PROJECT_REGISTRY_SERVER_IP_CACHE_PATH" ]]; then
  printf 'PROJECT_REGISTRY_SERVER_IP_CACHE_PATH=%s\n' "$PROJECT_REGISTRY_SERVER_IP_CACHE_PATH" >> "$environment_stage"
fi
if [[ -n "$PROJECT_REGISTRY_SERVER_IP_DISCOVERY_TIMEOUT_MS" ]]; then
